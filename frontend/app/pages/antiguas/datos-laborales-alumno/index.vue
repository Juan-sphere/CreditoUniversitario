        ...
        <template #information>
          <div class="p-4 space-y-4 text-gray-700">
            ...
            <div class="grid grid-cols-3 gap-4">
              <div>
                <label class="font-semibold text-sm"
                  >Estado laboral <span class="text-red-500">(*)</span></label
                >
                <select
                  v-model="form.estadoLaboral"
              ...
              <div>
                <label class="font-semibold text-sm"
                  >Remuneración neta Mensual</label
                >
                <input
              ...
              <div>
                <label class="font-semibold text-sm"
                  >Emite recibos por honorarios?</label
                >
                <select
                  v-model="form.emiteRecibos"
                  class="w-full px-3 py-1 border border-gray-300 rounded mt-1"
                >
                  <option value="">--Seleccione--</option>
                </select>
            ...
            <div class="grid grid-cols-[2fr_1fr_1fr] gap-4">
              <div>
                <label class="font-semibold text-sm"
                  >Razon Social de Centro Laboral
                  <span class="text-red-500">(*)</span></label
                >
                <input
