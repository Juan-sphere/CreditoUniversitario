<template>
  <div class="w-full">
    ...
    <Register :tabs="['Información adicional', 'Correo electrónico', 'Dirección', 'Datos laborales']"
      :activeTab="activeTab" @tab-change="activeTab = $event">
      <template #register>
        <!-- Información adicional -->
        <div class="grid grid-cols-2 gap-4 p-2" v-if="activeTab === 0">
          <div class="flex flex-col gap-2">
          ...
          <div class="flex flex-col gap-2">
            <label class="text-gray-700 font-semibold">Fecha de nacimiento <span class="text-red-500">(*)</span></label>
            <input type="date" class="w-full px-3 py-1 border border-gray-300 rounded" />
          </div>
          <div class="flex flex-col gap-2">
            <label class="text-gray-700 font-semibold">Lugar de nacimiento <span class="text-red-500">(*)</span></label>
            <select class="w-full px-3 py-1 border border-gray-300 rounded">
              <option>--Seleccione--</option>
            </select>
          </div>
        ...
        <div class="grid grid-cols-2 gap-4 p-2" v-if="activeTab === 1">
          <div class="flex flex-col gap-2">
            <label class="text-gray-700 font-semibold">Correo electrónico personal <span
                class="text-red-500">(*)</span></label>
            <input type="email" class="w-full px-3 py-1 border border-gray-300 rounded"
              placeholder="usuario@dominio.com" required />
          </div>
          <div class="flex flex-col gap-2">
            <label class="text-gray-700 font-semibold">Correo electrónico laboral <span
                class="text-red-500">(*)</span></label>
            <input type="email" class="w-full px-3 py-1 border border-gray-300 rounded"
              placeholder="usuario@dominio.com" required />
          </div>
        ...
        <!-- Dirección -->
        <div class="grid grid-cols-2 gap-4 p-2" v-if="activeTab === 2">
          <div class="flex flex-col gap-2">
          ...
          <div class="flex flex-col gap-2">
            <label class="text-gray-700 font-semibold">Número de vivienda <span class="text-red-500">(*)</span></label>
            <input type="text" class="w-full px-3 py-1 border border-gray-300 rounded"
        ...
        <div class="flex flex-col gap-4 p-2" v-if="activeTab === 3">
          <div class="flex flex-col gap-2">
            <label class="text-gray-700 font-semibold">¿El postulante trabaja? <span
                class="text-red-500">(*)</span></label>
          ...
          <template v-if="postulanteTrabaja === 'Si'">
            ...
            <div class="flex flex-col gap-2">
              <label class="text-gray-700 font-semibold">Ingresos mensuales (S/.) <span
                  class="text-red-500">(*)</span></label>
