<template>
  <div class="min-h-screen flex items-center justify-center py-12 px-4 bg-cover bg-center relative"
    ...
    <div class="absolute top-6 left-1/2 -translate-x-1/2 z-10">
      <img src="/images/logo.png" alt="ACCESSA" class="h-25 object-contain drop-shadow-xl" />
    </div>
    ...
    <div class="relative max-w-md w-full bg-white/95 backdrop-blur-sm rounded-xl shadow-2xl px-8 py-8">
      ...
      <div class="mt-6 text-center space-y-2">
        <p class="text-sm text-gray-600">
          ¿Primera vez aquí?
          <NuxtLink to="/registro" class="text-blue-600 font-medium hover:underline">
            Regístrate
          </NuxtLink>
        </p>
        <p class="text-sm">
          <a href="#" class="text-gray-500 hover:text-gray-700">¿Olvidaste tu contraseña?</a>
        </p>
      </div>
    </div>
  </div>
