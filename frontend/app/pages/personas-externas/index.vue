<template>
    <div class="w-full">
        <Information title="Personas que contribuyen externamente a la economía familiar">
            <template #information>
                <div class="p-4 space-y-6 text-gray-700 overflow-hidden">
                    <!-- Foreach para cada persona externa -->
                    <div v-for="(persona, index) in personasExternas" :key="index"
                        class="border border-gray-300 rounded p-4 space-y-4">
                        <div class="flex justify-between items-center mb-4">
                            <h3 class="text-secondary font-bold">Persona Externa {{ index + 1 }}</h3>
                            <button v-if="personasExternas.length > 1" @click="eliminarPersona(index)" type="button"
                        ...
                        <div class="grid grid-cols-4 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" v-model="persona.apellidoPaterno"
                            ...
                            <div>
                                <label class="font-semibold text-sm">Apellido Materno <span
                                        class="text-red-500">(*)</span></label>
                                <input type="text" v-model="persona.apellidoMaterno"
                                    class="w-full px-3 py-1 border border-gray-300 rounded mt-1" required />
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="text" v-model="persona.segundoNombre"
                                    class="w-full px-3 py-1 border border-gray-300 rounded mt-1" />
                            </div>
                            <div>
                                <label class="font-semibold text-sm">Parentesco o Relación <span
                                        class="text-red-500">(*)</span></label>
                                <select v-model="persona.parentesco"
                                    class="w-full px-3 py-1 border border-gray-300 rounded mt-1" required>
                                    <option value="">--Seleccione--</option>
                                    <option value="Amigo del postulante">Amigo del postulante</option>
                                    <option value="Amigo de la familia">Amigo de la familia</option>
                            ...
                            <div>
                                <label class="font-semibold text-sm">Edad <span class="text-red-500">(*)</span></label>
                                <input type="number" v-model="persona.edad"
                                    class="w-full px-3 py-1 border border-gray-300 rounded mt-1" min="0" required />
                            </div>
                            <div>
                                <label class="font-semibold text-sm">¿Trabaja? <span
                                        class="text-red-500">(*)</span></label>
                                <select v-model="persona.trabaja"
                                    class="w-full px-3 py-1 border border-gray-300 rounded mt-1" required>
                                    <option value="">--Seleccione--</option>
                            ...
                            <div v-if="persona.trabaja === 'Si'">
                                <label class="font-semibold text-sm">Tipo de Trabajo <span
                                        class="text-red-500">(*)</span></label>
                                <select v-model="persona.tipoTrabajo"
                                    class="w-full px-3 py-1 border border-gray-300 rounded mt-1" required>
                                    <option value="">--Seleccione--</option>
                                    <option value="Independiente permanente">Independiente permanente</option>
                                    <option value="Independiente temporal">Independiente temporal</option>
                                    <option value="Dependiente permanente">Dependiente permanente</option>
                                    <option value="Dependiente temporal">Dependiente temporal</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-4 gap-4">
                            ...
                            <div class="col-span-3">
                                <label class="font-semibold text-sm">Grado de Instrucción <span
                                        class="text-red-500">(*)</span></label>
                                <select v-model="persona.gradoInstruccion"
                                    class="w-full px-3 py-1 border border-gray-300 rounded mt-1" required>
                                    <option value="">--Seleccione--</option>
                            ...
                            <div class="col-span-4">
                                ...
                                <input type="text" v-model="persona.profesion"
                                    class="w-full px-3 py-1 border border-gray-300 rounded mt-1" />
                            </div>
                        </div>
                    </div>
                    ...
                    <button @click="agregarPersona" type="button" class="px-4 py-2 bg-primary text-white rounded">
