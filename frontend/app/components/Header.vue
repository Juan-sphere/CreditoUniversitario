<template>
  <div
    class="bg-primary text-white h-16 flex items-center justify-between px-8 shadow-lg fixed top-0 left-0 right-0 z-50"
  >
    <!-- Menú izquierdo -->
    <div class="flex gap-8">
      <div class="cursor-pointer hover:opacity-80 transition">BANDEJA</div>
      <div class="cursor-pointer hover:opacity-80 transition">
        CAMBIAR CONTRASEÑA
      </div>
      <div class="cursor-pointer hover:opacity-80 transition">FORMATOS</div>
      <div class="cursor-pointer hover:opacity-80 transition">
        ESTADO SOLICITUD
      </div>
    </div>
